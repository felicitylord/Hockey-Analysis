                                    ...
                                    tabPanel("Interpret",  
                                      fluidRow(
                                        ...
                                        column(12, h5("To access Ball Movement profiles select the Ball Movement tab and Team Profiles sub-category."),
                                               br()),
                                        column(12, img(src = "BM Profile.png", style="display: block; margin-left: auto; margin-right: auto;", height = 304.34, width = 520.34),
                                               br()),
                                        ...
                                        column(12, h5("To access Ball Movement variables select the Ball Movement tab and Heat Maps sub-category."),
                                               br()),
                                        column(12, img(src = "Heat Maps.png", style="display: block; margin-left: auto; margin-right: auto;", height = 302, width = 616.67),
                                               br()),
                                      ...
                                      navlistPanel(widths = c(2, 10),
                                                   ...
                                                   tabPanel("Definitions",
                                                            fluidRow(
                                                              ...
                                                              br()),
                                                            fluidRow(
                                                              column(4, img(src = "Attack_Zones.png", style="display: block; margin-left: auto; margin-right: auto;", height = 310, width = 255),
                                                              ))),
                                                   navbarMenu("Team Profiles",
